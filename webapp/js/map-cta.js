/* Bottom-right CTA: Chica face + CLICK ME. */
(function () {
  ...
  function face() {
    return window.__CHICA_PEEK_STILL || LOGO;
  }
  ...
  function css() {
    ...
    s.textContent =
      ...
      "#chica-listit-btn img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center 18%;pointer-events:none;background:#c513af}" +
  ...
  function paint() {
    ...
    if (a.getAttribute("data-painted") !== "5") {
      a.setAttribute("data-painted", "5");
      a.innerHTML =
        '<img alt="Chica" width="112" height="112">' +
