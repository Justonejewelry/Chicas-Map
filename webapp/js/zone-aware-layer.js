...
(function () {
  ...
  /* The County layer is point geometry, so these are safety buffers around campuses,
     not claims about official/legal school-zone boundaries. Radius is selected from
     the County's school type/span fields; district only tunes the time envelope. */
  function profile(p){
