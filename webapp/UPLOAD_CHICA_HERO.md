...
The landing hero, Backyard bio, and Sponsor page will pick it up automatically.

Optimized file is ready in the project artifacts as `brand/chica-hero-cape-sm.jpg` (~54KB).
