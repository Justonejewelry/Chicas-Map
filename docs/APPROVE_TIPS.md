...
When a review email arrives (`Chicas-Map permit tip — review`):
...
1. Open [New issue](https://github.com/Justonejewelry/Chicas-Map/issues/new).
...
Page: https://justonejewelry.github.io/Chicas-Map/admin/approve.html
